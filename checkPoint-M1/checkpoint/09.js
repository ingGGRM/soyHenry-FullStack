...
BinarySearchTree.prototype.obtenerPrendas = function (string, final = []) {
	// Tu código aquí:
  
	if (this.value.nombre === string) final.push(this.value.nombre);

	if (this.left) this.left.obtenerPrendas(string, final);

	if (this.right) this.right.obtenerPrendas(string, final);
