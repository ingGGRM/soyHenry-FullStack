...
// Tu código acá:
document.querySelector("#createdBy").innerHTML += " Genesis";
...
function buildToDo(todo, index) {
	...
	// toDoText.addEventListener("click", completeToDo); // Commented becouse of EXTRA CREDIT TASK
	toDoText.innerHTML = todo.description;
	// toDoText.setAttribute("id", index); // Commented becouse of EXTRA CREDIT TASK

	if (todo.complete) {
		toDoText.classList.add("completeText");
		toDoCheck.setAttribute("checked", true); // EXTRA CREDIT TASK
	}

	toDoShell.appendChild(toDoCheck); // EXTRA CREDIT TASK
...
function addToDo() {
	...
	var inputToDo = new ToDo(input.value);
